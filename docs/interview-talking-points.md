...
- Test plan, documented test cases, bug report template, source health diagnostics, and 103
  automated tests with failure evidence (screenshot/trace/video) configured.
